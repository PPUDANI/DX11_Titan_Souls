...
void Player::CreatePlayerbodyAnimation()
{
	...
	// StandUp Animations
	BodyRenderer->CreateAnimation("StandUp", "Player.png", 0.15f, 79, 88, false);
...
void Player::CreateBowAnimation()
{
	...
	// StandUp Animations
	BowRenderer->CreateAnimation("StandUp", "Bow.png", 0.15f, 79, 88, false);
...
void Player::CreateArrowInBagAnimation()
{
	...
	// StandUp Animations
	ArrowInBagRenderer->CreateAnimation("StandUp", "Arrow.png", 0.15f, 79, 88, false);
