...
#include "SubTileMap.h"
#include <vector>

SubTileMap::SubTileMap()
{
}
...
void SubTileMap::TileMapInit(int _IndexX, int _IndexY, std::string_view _TextureName)
{
	IndexX = _IndexX;
	IndexY = _IndexY;
...
void SubTileMap::SetTileTexture(RENDERING_ORDER _Order)
{
...
void SubTileMap::Start()
{

}

void SubTileMap::Update(float _Delta)
{
